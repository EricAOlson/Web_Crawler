...
if(array_key_exists('term',$_GET))
{
    $command = escapeshellcmd("/usr/bin/python omega_webcrawl.py ".$Start." ".$Method." ".$Max." \"".urldecode($Term)."\"");
}
else
{
    $command = escapeshellcmd("/usr/bin/python omega_webcrawl.py ".$Start." ".$Method." ".$Max);
}
